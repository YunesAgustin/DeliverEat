...
app.config(function ($routeProvider) {
    ...
    $routeProvider.
        when('/PedidoComercioNoAdherido',
        {
            templateUrl: '/_PedidoComercioNoAdherido.html'
        }).
        when('/Pago',
        {
        ...
        otherwise(
        {
            redirectTo: '/PedidoComercioNoAdherido'  //si no se encuentra la ruta en los when anteriores lo redirige a /inicio
        });
});
...
app.controller("appController", function ($scope, $http, myService, fileReader) {
    ...
    $scope.redirect('PedidoComercioNoAdherido');
